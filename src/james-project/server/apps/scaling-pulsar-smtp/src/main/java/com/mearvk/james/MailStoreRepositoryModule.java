...
import com.mearvk.james.mailrepository.api.MailRepositoryLoader;
import com.mearvk.james.mailrepository.api.MailRepositoryStore;
import com.mearvk.james.mailrepository.memory.MailRepositoryStoreConfiguration;
import com.mearvk.james.mailrepository.memory.MemoryMailRepositoryStore;
import com.mearvk.james.modules.mailrepository.guice.MultiBoundGuiceRepositoryLoader;
...
import com.mearvk.james.utils.MailRepositoryProbeImpl;
...
public class MailStoreRepositoryModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(MultiBoundGuiceRepositoryLoader.class).in(Scopes.SINGLETON);
        bind(MailRepositoryLoader.class).to(MultiBoundGuiceRepositoryLoader.class);
