 ...
 * under the License.                                           *
 ****************************************************************/
package com.mearvk.james.blob.cassandra.cache;

import static com.mearvk.james.backends.cassandra.Scenario.Builder.fail;
import static com.mearvk.james.blob.api.BlobStore.StoragePolicy.HIGH_PERFORMANCE;
import static com.mearvk.james.blob.api.BlobStore.StoragePolicy.LOW_COST;
import static com.mearvk.james.blob.api.BlobStore.StoragePolicy.SIZE_BASED;
import static com.mearvk.james.blob.api.BucketName.DEFAULT;
import static com.mearvk.james.blob.cassandra.cache.BlobStoreCacheContract.EIGHT_KILOBYTES;
import static com.mearvk.james.blob.cassandra.cache.CachedBlobStore.BLOBSTORE_BACKEND_LATENCY_METRIC_NAME;
import static com.mearvk.james.blob.cassandra.cache.CachedBlobStore.BLOBSTORE_CACHED_HIT_COUNT_METRIC_NAME;
import static com.mearvk.james.blob.cassandra.cache.CachedBlobStore.BLOBSTORE_CACHED_LATENCY_METRIC_NAME;
import static com.mearvk.james.blob.cassandra.cache.CachedBlobStore.BLOBSTORE_CACHED_MISS_COUNT_METRIC_NAME;
...
import com.mearvk.james.backends.cassandra.StatementRecorder.Selector;
...
import com.mearvk.james.blob.api.BlobStoreContract;
import com.mearvk.james.blob.api.BucketName;
import com.mearvk.james.blob.api.ObjectNotFoundException;
import com.mearvk.james.blob.api.PlainBlobId;
import com.mearvk.james.blob.api.Store;
import com.mearvk.james.blob.api.TestBlobId;
import com.mearvk.james.blob.cassandra.CassandraBlobDataDefinition;
import com.mearvk.james.blob.cassandra.CassandraBlobStoreFactory;
import com.mearvk.james.blob.mail.MimeMessagePartsId;
import com.mearvk.james.blob.mail.MimeMessageStore;
...
public class CachedBlobStoreTest implements BlobStoreContract {
    ...
    static CassandraClusterExtension cassandraCluster = new CassandraClusterExtension(
        CassandraDataDefinition.aggregateModules(CassandraBlobDataDefinition.MODULE, CassandraBlobCacheDataDefinition.MODULE));
