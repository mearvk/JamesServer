...
import com.mearvk.james.jmap.api.model.{UploadMetaData, UploadNotFoundException}
import com.mearvk.james.jmap.api.upload.UploadServiceContract.{BOB, CONTENT_TYPE, TEN_BYTES_DATA_STRING, UPLOAD_QUOTA_LIMIT, awaitAtMostTwoMinutes}
