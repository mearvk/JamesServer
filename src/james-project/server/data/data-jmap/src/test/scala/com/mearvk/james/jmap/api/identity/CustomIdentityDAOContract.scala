...
import com.mearvk.james.core.{MailAddress, Username}
import com.mearvk.james.jmap.api.identity.CustomIdentityDAOContract.{CREATION_REQUEST, bob}
import com.mearvk.james.jmap.api.identity.IdentityRepositoryTest.{BOB, IDENTITY1}
import com.mearvk.james.jmap.api.model.{EmailAddress, EmailerName, HtmlSignature, Identity, IdentityId, IdentityName, MayDeleteIdentity, TextSignature}
