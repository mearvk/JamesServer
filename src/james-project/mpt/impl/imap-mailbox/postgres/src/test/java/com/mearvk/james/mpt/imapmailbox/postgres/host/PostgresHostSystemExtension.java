...
import com.mearvk.james.backends.postgres.quota.PostgresQuotaDataDefinition;
...
public class PostgresHostSystemExtension implements BeforeEachCallback, AfterEachCallback, BeforeAllCallback, AfterAllCallback, ParameterResolver {
    ...
    public PostgresHostSystemExtension() {
        this.postgresExtension = PostgresExtension.withoutRowLevelSecurity(PostgresDataDefinition.aggregateModules(
